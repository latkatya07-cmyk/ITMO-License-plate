...
class CRNNDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        image = Image.open(img_path).convert("L").resize((self.img_w, self.img_h), Image.BICUBIC)
...
def main():
    ...
    print(f"[{EXP_NAME}] Device: {DEVICE} | Classes: {num_classes}")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(f"Epoch {epoch:2d} | LR: {current_lr:.2e} | Train: {train_loss:.4f} | Val: {val_loss:.4f} | CER: {val_cer:.4f} | Acc: {val_acc:.4f}")
