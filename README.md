...
|:------------|:-------------|:---------|:-----------:|:-----------------:|:------|
| **Baseline** | `32×100`, `lr=1e-3`, `Adam`, 20 эпох | Стандартные гиперпараметры | `0.063` | `0.594` | ✅ Выбран как финальная модель, но количество эпох финальной модели увеличено |
...
| **Exp 3**    | `32×100` + `Augmentations`, 20 эпох | RandomAffine, ColorJitter, Flip | `0.334` | `0.024` | ❌ Малый датасет + аугментации = недообучение за 20 эпох |
